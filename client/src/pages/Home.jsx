...
const Home = () => {
  ...
  return (
    ...
    <div className="max-w-7xl flex flex-col justify-center items-center mx-auto">
      <div className="bg-[#769bfa] dark:bg-gray-600 text-slate-200 m-4 flex flex-col justify-center md:gap-10 rounded-lg lg:p-28 p-4 sm:p-10 shadow-lg mb-10 mt-20 md:h-[75vh]">
        ...
        <Link to={'/search'} className="group flex justify-center py-4 dark:text-teal-400 w-fit text-lg" >
          <span className="text-xl flex justify-center items-center gap-1"> View all Posts <HiArrowSmRight className="group-hover:pl-3 w-fit transition-all duration-300" /></span>
        </Link>
      </div>
