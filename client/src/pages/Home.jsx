...
const Home = () => {
  ...
  return (
    <div className="max-w-7xl flex flex-col justify-center items-center mx-auto">
      <div className="bg-[#3f75ff] dark:bg-gray-600 text-slate-200 m-4 rounded-lg lg:p-28 p-4 sm:p-10 shadow-lg my-10">
        ...
        <Link to={'/serach'} className="group flex justify-center py-4 dark:text-teal-400 w-fit text-lg" >
